 ...
 *
 * Exit code:
 *   0  — golden AND spanish-recall AND elections-colombia passed AND calibration
 *        guardrails held at every floor
...
async function main() {
  ...
  const HR = "─".repeat(72);
  console.log(
    "\n[quality-gate] Dashboard quality gate — golden + spanish-recall + elections-colombia + calibration"
  );
  console.log(HR);

  // ── 1. Golden eval ──────────────────────────────────────────────────────
  console.log("[quality-gate] (1/4) running dashboard-refresh-golden …");
  ...
  console.log("[quality-gate] (2/4) running dashboard-spanish-recall …");
  ...
  console.log("[quality-gate] (3/4) running dashboard-elections-colombia …");
  ...
  // ── 4. Calibration eval ─────────────────────────────────────────────────
  console.log("[quality-gate] (4/4) running dashboard-calibration …");
  ...
  if (!goldenPass || !spanishPass || !electionsPass || !calibrationPass) {
