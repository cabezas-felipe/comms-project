...
export const WHY_IT_MATTERS_PROMPT_VERSION = "why-it-matters-prompt-v0";
...
export const WHY_SYSTEM_PROMPT = [
  ...
  "- Use posture/readiness language; do not give tasking instructions.",
  "- Anchor implications to observable coverage patterns (source spread, framing divergence, cadence shifts), not speculation.",
  "- Maintain neutral bilateral framing.",
  "- Calibrate certainty to evidence strength ('may', 'suggest', 'early signal' when thin; firmer language only when source spread + framing support it).",
  "- One clear implication category per line.",
  "",
  ...
  "",
  "Taxonomy (pick exactly one for taxonomyPrimary):",
  "- monitoring_intensity",
  "- narrative_stability",
  "- stakeholder_exposure",
  "- coordination_pressure",
